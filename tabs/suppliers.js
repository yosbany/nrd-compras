...
function loadSuppliers() {
  ...
  suppliersListener = window.nrd.suppliers.onValue((suppliers) => {
    ...
    if (suppliersSearchTerm.trim()) {
      ...
      const normalizedTerm = normalizeSearchText(suppliersSearchTerm.trim());
      suppliersToShow = suppliersToShow.filter(([id, supplier]) => {
        ...
        const email = normalizeSearchText(supplier.email || '');
        const address = normalizeSearchText(supplier.address || '');
